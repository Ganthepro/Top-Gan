...
#     for x in reversed(range(0,n_wx,scale)):
#         if x - 1 < 0:  # ซ้าย
#             e = px_im[x, y]
#         else:
#             e = px_im[x - 1, y]
...
#             im.putpixel((x, y), (e[0], e[1], e[2]))
#             for i in vec:
#                 if x == (i[ex] * scale) + xshift and y == (i[ey] * scale) + (yshift - 2):
# #                    count_1 += 1
#                     #print(((i[sx] * scale) + xshift, (i[sy] * scale) + (yshift - 2)),((i[ex] * scale) + xshift, (i[ey] * scale) + (yshift - 2)))
#                     dwg.add(dwg.line(((i[sx] * scale) + xshift, (i[sy] * scale) + (yshift - 2)),
#                                      ((i[ex] * scale) + xshift, (i[ey] * scale) + (yshift - 2)),
#                                      stroke=svg.rgb(e[0], e[1], e[2], 'RGB')))
#
# for y in range(0,n_hy,scale):
...
#                     dwg.add(dwg.line(((i[sx] * scale) + xshift, (i[sy] * scale) + (yshift - 2)),
#                                      ((i[ex] * scale) + xshift, (i[ey] * scale) + (yshift - 2)),
#                                      stroke=svg.rgb(b[0], b[1], b[2], 'RGB')))
#
# for y in range(0,n_hy,scale):
#     for x in range(0,n_wx,scale):
#         if y-1 < 0:
...
#             k= px_im[x-1,y-1]
#         if px_im[x, y] == (0, 255, 0, 255):
#             im.putpixel((x, y), (k[0], k[1], k[2]))
#             for i in vec:
#                 if x == (i[ex] * scale) + xshift and y == (i[ey] * scale) + (yshift - 2):
#                     # count_1 += 1
#                     dwg.add(dwg.line(((i[sx] * scale) + xshift, (i[sy] * scale) + (yshift - 2)),
#                                      ((i[ex] * scale) + xshift, (i[ey] * scale) + (yshift - 2)),
#                                      stroke=svg.rgb(k[0], k[1], k[2], 'RGB')))
#
# for y in range(0,n_hy,scale):
#     for x in range(0,n_wx,scale):
#         if y + 1 == hy:
...
#             g = px_im[x + 1, y + 1]
#         if px_im[x, y] == (0, 255, 0, 255):
#             im.putpixel((x, y), (g[0], g[1], g[2]))
#             for i in vec:
#                 if x == (i[ex] * scale) + xshift and y == (i[ey] * scale) + (yshift - 2):
#                     # count_1 += 1
#                     print(((i[sx] * scale) + xshift, (i[sy] * scale) + (yshift - 2)),
#                           ((i[ex] * scale) + xshift, (i[ey] * scale) + (yshift - 2)))
#                     dwg.add(dwg.line(((i[sx] * scale) + xshift, (i[sy] * scale) + (yshift - 2)),
#                                      ((i[ex] * scale) + xshift, (i[ey] * scale) + (yshift - 2)),
#                                      stroke=svg.rgb(g[0], g[1], g[2], 'RGB')))
#im.show('test.png')
